  ...
  return (
    <div className='flex flex-col items-center justify-center h-full w-full'>
      <form
        ...
        <div className='mb-5 text-4xl font-thin'>Login</div>
        <input
        ...
        <a
          href={`${config.FB.AUTH_CODE_URL}?client_id=${config.FB.CLIENT_ID}&redirect_uri=${config.FB.REDIRECT_URI}`}
        ...
        <a
          href={`${config.INSTAGRAM.AUTH_CODE_URL}?client_id=${config.INSTAGRAM.CLIENT_ID}&redirect_uri=${config.INSTAGRAM.REDIRECT_URI}&response_type=code&scope=user_profile`}
